...
void GEMVoxParallelWorld::Construct()
{
    ...
    G4Box *ghostDetectorZero = new G4Box("GhostDetectorBoxZero", detHalfDimension, detHalfDimension, 1*cm);
    G4LogicalVolume *GhostDetectorZeroLog = new G4LogicalVolume(ghostDetectorZero, 0, "GhostDetectorZeroLog");
    new G4PVPlacement(0, G4ThreeVector(0, 0, 1*cm-11*cm), GhostDetectorZeroLog, "GhostDetectorZeroPhys", worldLog, 0, 0);
    ...
    G4Box* ghostXBoxZero = new G4Box("ghostXBoxZero", halfBoxWidth, detHalfDimension, 1*cm);
    ...
    G4Box* ghostYBoxZero = new G4Box("ghostYBoxZero", halfBoxWidth, halfBoxWidth, 1*cm);
    ...
    G4Box *ghostDetectorPeak = new G4Box("GhostDetectorBoxPeak", detHalfDimension, detHalfDimension, 1*cm);
    G4LogicalVolume *GhostDetectorPeakLog = new G4LogicalVolume(ghostDetectorPeak, 0, "GhostDetectorPeakLog");
    new G4PVPlacement(0, G4ThreeVector(0, 0, 5*cm), GhostDetectorPeakLog, "GhostDetectorPeakPhys", worldLog, 0, 0);
